...
export default function ScoreRecommendation() {
  ...
  const { data: appData } = useQuery<{ app: any; score: any }>({
              ...
              {[
                {
                  step: "1",
                  title: "Data Parsing",
                  desc: "Parsed 26 fields from CTOS",
                  status: "completed",
                },
                {
                  step: "2",
                  title: "Rule Engine",
                  desc: "Applied 12 Chin Hin policy rules",
                  status: "completed",
                },
                {
                  step: "3",
                  title: "Risk Simulation",
                  desc: "Simulated limit at RM 500k",
                  status: "completed",
                },
                {
                  step: "4",
                  title: "Rec Generation",
                  desc: "Built rationale & category",
                  status: "completed",
                },
              ].map((s, i) => (
                <div
          ...
          <CardContent className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              ...
              <div className="flex flex-col items-center justify-center border-x border-slate-700/50 px-8">
                ...
                <div className="relative">
                  <svg className="w-24 h-24 transform -rotate-90">
                    ...
                    <circle
                      ...
                      strokeDashoffset={251.2 * (1 - scorePct)}
                ...
                <Badge
                  className={`mt-4 ${badgeColor} text-white font-black px-4 py-1`}
                >
                  {riskLabel.toUpperCase().replace("_", " ")} RISK
                </Badge>
              </div>
              ...
              <div className="flex flex-col items-center justify-center pl-4 text-center">
                ...
                <p className="text-sm text-slate-300 font-medium mt-1">
                  {recommendation === "approve" ? "Full" : "Recommended"} Limit:
